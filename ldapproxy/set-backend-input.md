...
| :------------------------------ | :-------- | :------- | :------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [base_dn](#base_dn)             | `string`  | Optional | cannot be null | [set-backend input](set-backend-input-properties-base-dn.md "http://schema.nethserver.org/ldapproxy/set-backend-input.json#/properties/base_dn")                       |
| [bind_dn](#bind_dn)             | `string`  | Optional | cannot be null | [set-backend input](set-backend-input-properties-bind-dn.md "http://schema.nethserver.org/ldapproxy/set-backend-input.json#/properties/bind_dn")                       |
| [bind_password](#bind_password) | `string`  | Optional | cannot be null | [set-backend input](set-backend-input-properties-bind-password.md "http://schema.nethserver.org/ldapproxy/set-backend-input.json#/properties/bind_password")           |
...
*   Type: `string` ([Base DN](set-backend-input-properties-base-dn.md))

*   cannot be null

*   defined in: [set-backend input](set-backend-input-properties-base-dn.md "http://schema.nethserver.org/ldapproxy/set-backend-input.json#/properties/base_dn")
...
*   Type: `string` ([Bind DN](set-backend-input-properties-bind-dn.md))

*   cannot be null

*   defined in: [set-backend input](set-backend-input-properties-bind-dn.md "http://schema.nethserver.org/ldapproxy/set-backend-input.json#/properties/bind_dn")
...
*   Type: `string` ([Bind password](set-backend-input-properties-bind-password.md))

*   cannot be null

*   defined in: [set-backend input](set-backend-input-properties-bind-password.md "http://schema.nethserver.org/ldapproxy/set-backend-input.json#/properties/bind_password")
